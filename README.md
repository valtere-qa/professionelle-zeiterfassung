...
UI-Kennung dieser Änderung: `stable-ui.js?v=20260908-39`, `auth-ui.js?v=20260908-6` und `extra.js?v=20260907-25`. Die URL der veröffentlichten App ist [Professionelle Zeiterfassung](https://professionelle-zeiterfassung.vafa-qa-engineering.workers.dev/).
