...
UI-Kennung dieser Änderung: `stable-ui.js?v=20260908-43`, `auth-ui.js?v=20260908-13`, `extra.js?v=20260908-29` und `apple-icons.js?v=20260908-1`. Die URL der veröffentlichten App ist [Professionelle Zeiterfassung](https://professionelle-zeiterfassung.vafa-qa-engineering.workers.dev/).
