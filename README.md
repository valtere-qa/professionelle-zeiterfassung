...
UI-Kennung dieser Änderung: `stable-ui.js?v=20260908-33` und `extra.js?v=20260907-25`. Die URL der veröffentlichten App ist [Professionelle Zeiterfassung](https://professionelle-zeiterfassung.vafa-qa-engineering.workers.dev/).
...
Ergebnis am 8. September 2026: **32 Tests bestanden, 0 fehlgeschlagen**. Die mobile Navigation wird zusätzlich anhand ihrer CSS-Regeln und mit simulierten Abmessungen geprüft.
