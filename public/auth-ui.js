(() => {
  ...
  const setProfile=(user)=>{
    ...
    const login=document.querySelector("#authLogin"); const logout=document.querySelector("#authLogout");
  ...
  const enhance=()=>{
    ...
    const quick= document.querySelector("#authQuick"); if(quick)quick.remove();
